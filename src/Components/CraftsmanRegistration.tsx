...
function CraftsmanRegistration() {
  ...
  const handleClickOutsideAdditionalInfo= (event: MouseEvent) => {
    const showPasswordInfo = document.querySelector(`.${styles.showPasswordInfo}`);
    const showExperienceInfo = document.querySelector(`.${styles.showExperienceInfo}`);
    ...
    if (
      ...
      (showExperienceInfo && !showExperienceInfo.contains(event.target as Node)) ||
  ...
  useEffect(() => {
    ...
    return () => {
      document.removeEventListener("mousedown", handleClickOutsideAdditionalInfo);
    };
  }, []);
  ...
  return (
    <div className={styles.parentContainer}>
      ...
      <h2 className={styles.header}>რეგისტრაცია</h2>
        <form 
          ...
          <div className={styles.registrationForm}>
            ...
            <div
              ...
              >
                ...
                <p>
                 მინიმუმ 8 სიმბოლო. აუცილებელია მინიმუმ ერთი ლათინური ასო, დასაშვებია როგორც ციფრები ასევე რიცხვები
                </p>
              </div>
...
{additionalInformation === "experience" ? (
            ...
            <div
              ...
              >
                ...
                <p>
               იმ შემთხვევაში თუ შესრულებული სამუშაო ითვლება წერტილებით მიუთითეთ ერთი წერტილის შესრულების ღირებულება,
               თუ შესრულებული სამუშაო ითვლება კვადრატული მეტრებით მიუთითეთ ერთი კვადრატული მეტრის შესრულების ღირებულება.
                </p>
              </div>
...
{additionalInformation === "price" ? (
            ...
            <div className={styles.inputCard}>
              ...
              >
                ...
                <p>
                 მიუთითეთ ის მინიმალური თანხა, რასაც იღებთ ერთ ობიექტზე ვიზიტისას შესრულებული სამუშაოს სანაცვლოდ
                </p>
              </div>
              <div className={styles.inputCard__labelBox}>
            ...
            <div className={`${styles.inputCard} ${styles.cardOfTextarea}`}>
              ...
              >
                ...
                <p>
                 მოგვაწოდე დამატებითი ინფორმაცია შენი საქმიანობის, პირობების, ვადების და სერვისების შესახებ.
                </p>
              </div>
              <div className={styles.inputCard__labelBox}>

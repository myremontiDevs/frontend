...
function SearchResults(){
    ...
    const context = useContext(MainContext);
      ...
      const {searchByDistrict, searchByProfession, searchByVerification, searchByExperience, searchByPriceFrom, searchByPriceUpTo} = context;
      ...
      const SearchedData = data.filter((craftsman)=>{
        ...
        return matchesDistrict && matchesProfession && matchesVerification && matchespriceFrom && mathesPriceUpTo && matchesExperience;
      })

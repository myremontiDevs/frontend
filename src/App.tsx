...
export const MainContext = createContext<MainContextInteface>({
  ...
  filterByCity: "თბილისი",
  setFilterByCity: () => {},
  filterByDistrict: "",
  setFilterByDistrict: () => {},
  filterByProfession: "",
  setFilterByProfession: () => {},
  searchByCity: "თბილისი",
  setSearchByCity: () => {},
  searchByDistrict: "",
  setSearchByDistrict: () => {},
  searchByProfession: "",
